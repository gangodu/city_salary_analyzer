...
public class MR
{
	...
	{
	    JobConf conf = new JobConf(interview.MR.class);
...
//	    conf.setOutputFormat((Class<? extends OutputFormat>) IntWritable.class);
//	    conf.setInputFormat(IntWritableFormat.class);
